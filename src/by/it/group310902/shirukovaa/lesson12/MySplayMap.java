...
public class MySplayMap<Integer extends Comparable<Integer>, String> implements NavigableMap<Integer, String> {
    ...
    // Ставим узел с заданным ключом на корень
    ...
    // Получение узлов, меньших указанного ключа
    ...
    // Получение узлов, больших указанного ключа
    ...
    // Получение поддерева с узлами до указанного ключа
    @Override
    ...
    // Получение поддерева с узлами от указанного ключа
    @Override
