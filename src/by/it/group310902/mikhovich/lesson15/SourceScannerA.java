...
public class SourceScannerA {
    ...
    List<by.it.group310902.mikhovich.lesson15.SourceScannerA.FileInfo> fileInfoList = new ArrayList<>();
        ...
        public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) throws IOException {
            ...
            if (file.toString().endsWith(".java")) { // Проверяем, заканчивается ли имя файла на ".java"
                ...
                if (!content.contains("@Test") && !content.contains("org.junit.Test")) { // Проверяем, не содержит ли содержимое файла  @Test или org.junit
                    ...
                    fileInfoList.add(new by.it.group310902.mikhovich.lesson15.SourceScannerA.FileInfo(file, content.length()));
                }
            }
    ...
    fileInfoList.sort(Comparator.comparingInt(by.it.group310902.mikhovich.lesson15.SourceScannerA.FileInfo::getSize)
            .thenComparing(fileInfo -> fileInfo.getPath().toString()));

    // Вывод информации о файлах
    for (by.it.group310902.mikhovich.lesson15.SourceScannerA.FileInfo fileInfo : fileInfoList) {
