package by.it.group351001.budnikov.lesson13;
...
public class GraphB {
    ...
    public static boolean isCyclic(BaseGraph graph) {
    ...
    static boolean isCyclicUtil(BaseGraph graph, int vertex) {
        if (!visited[vertex]) {
            visited[vertex] = true;
            stack[vertex] = true;
    ...
    public static void main(String[] args) {
        ...
        BaseGraph graph = new BaseGraph(getMax(startVertex, endVertex) + 1);
        for (int i = 0; i < arr.length; i++)
