package by.it.group310901.mikhaylove.lesson13;

import java.util.*;
import java.util.Map.Entry;
//Обход графа для определения времени завершения обработки каждой вершины.
//Сортировка вершин в порядке убывания времени завершения.
//Второй раз обходит Т граф
public class GraphC {
