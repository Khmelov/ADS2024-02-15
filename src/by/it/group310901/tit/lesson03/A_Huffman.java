...
/* - Метод кодирует строку из файла, используя алгоритм Хаффмана.
   - Считывает строку из файла и вычисляет частоту каждого символа, хранящуюся в карте count.
   - Процесс рассмотрен только частично, включая подсчет частот символов,
   что является важной частью алгоритма Хаффмана.*/
