package by.it.group351002.stepanenko.lesson11;
...
// связынй список позволяет предсказать порядок итерации
public class MyLinkedHashSet<E> implements Set<E> {
    ...
    // узел как в связанных списках хэш-таблицы, так и в общем связанном списке порядка вставки.
    ...
    //когда количество элементов становится равным емкости хеш-таблицы, вызывается для удвоения емкости.
    private void resize(){
    ...
    //содержит ли набор все элементы заданной коллекции.
    @Override
