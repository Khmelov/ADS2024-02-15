package by.it.group310901.mikhaylove.lesson14;

import java.util.*;
import java.util.stream.Collectors;
//определить группы точек, где расстояние между любой парой точек в группе не превышает заданное значение. И вывод в порядке убывания
