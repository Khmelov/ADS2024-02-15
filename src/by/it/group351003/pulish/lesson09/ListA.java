package by.it.group351003.pulish.lesson09;
...
public class ListA<E> implements List<E> {
    ...
    public String toString() {
        ...
        sb.append("[");
        Iterator<E> it = by.it.group351003.pulish.lesson09.ListA.this.iterator();
        if(it.hasNext()){
            sb.append(it.next());
        }
        while(it.hasNext()){
    ...
    public boolean contains(Object o) {
        Iterator it = by.it.group351003.pulish.lesson09.ListA.this.iterator();
        while(it.hasNext()){
            if(it.next().equals(o)){
                return true;
            }
    ...
    public ListIterator<E> listIterator(int index) {
        return new ListIterator<>() {
            ...
            public void remove() {
                if(currentIndex > -1) {
                    by.it.group351003.pulish.lesson09.ListA.this.remove(currentIndex--);
                }
            }
            ...
            public void set(E e) {
                if(currentIndex > -1){
                    by.it.group351003.pulish.lesson09.ListA.this.set(currentIndex,e);
                }
            }

            @Override
            public void add(E e) {
                by.it.group351003.pulish.lesson09.ListA.this.add(e);
            }
        };
    }
    ...
    public ListIterator<E> listIterator() {
        return by.it.group351003.pulish.lesson09.ListA.this.listIterator(0);
    }
