package by.it.group310902.bladyko.lesson12;

import java.util.*;

// Красно-чёрное дерево — это самосбалансирующееся двоичное дерево поиска,
// которое обеспечивает логарифмическое время выполнения основных операций:
// вставки, удаления и поиска. Оно использует дополнительные свойства, связанные с цветами узлов
// (красный и чёрный), чтобы поддерживать сбалансированность.
