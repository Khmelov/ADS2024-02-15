...
public class MyRbMap implements SortedMap<Integer, String> {
    ...
    //войство color определяет, является ли узел красным или черным (красный = ложь, черный = истина).
    ...
    //за вставками и удалениями следуют шаги по восстановлению свойств дерева для поддержание баланса
    // и обеспечение, чтобы у красных узлов не было красных потомков.
    ...
    //Вставляет пару ключ-значение в карту. Дерево перебалансируется после вставки в соответствии с правилами дерева RB.
    @Override
...
//        checkrules("put");
    ...
    //для поворота частей дерева с целью сохранения баланса во время вставки или удаления.
    ...
    //используются после вставки нового узла для восстановления свойств дерева RB.
