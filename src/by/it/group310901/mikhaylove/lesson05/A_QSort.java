package by.it.group310901.mikhaylove.lesson05;
...
Программа определяет, сколько камер видеонаблюдения зафиксировали каждое событие на площади.
Она считывает данные о времени работы камер и времени событий
сортирует камеры по времени и для каждого события определяет количество зафиксированных камер..
