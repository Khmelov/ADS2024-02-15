package by.it.group351004.kostyukov.lesson13;
...
public class GraphC {
    ...
    public static void main(String[] args) {
        ...
        visited.clear();
        while (!stack.empty()) {
            String currVertex = stack.pop();    //идем с конца стека и находим в транспонированном графе все компоненты связности
