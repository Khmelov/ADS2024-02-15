...
public class MyTreeSet<E> implements Set<E> {
    ...
    //двоичный поиск для нахождения индекса элемента.найден-возвращает  индекс. нет -возвращает отрицательное значение,
// указывающее, куда следует вставить элемент для поддержания порядка
    ...
    //выполняет бинарный поиск,для проверки. не допускают дублирования элементов
    @Override
