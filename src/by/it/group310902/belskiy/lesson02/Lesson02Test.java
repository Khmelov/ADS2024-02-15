package by.it.group310902.belskiy.lesson02;
...
public class Lesson02Test {
    ...
    */
    ...
    public void B_Sheduler() {
        ...
        int from = 0;
        int to = 10;
        List<B_Sheduler.Event> starts = instance.calcStartTimes(events, from, to);  //рассчитаем оптимальное заполнение аудитории
