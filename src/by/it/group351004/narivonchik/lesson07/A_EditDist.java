package by.it.group351004.narivonchik.lesson07;
...
public class A_EditDist {
    ...
    int getDistanceEdinting(String one, String two) {
        //!!!!!!!!!!!!!!!!!!!!!!!!!     НАЧАЛО ЗАДАЧИ     !!!!!!!!!!!!!!!!!!!!!!!!!
        //инициализируем двумерный массив значением "бесконечность"
        int n = one.length();
        int m = two.length();
        d = new int[n+1][m+1];
        for (int i = 0; i <= n; i++){
        ...
        //рекурсивно редактируем всю матрицу расстояний, в ячейке [n][m] в итоге окажется расстояние Левенштейна
