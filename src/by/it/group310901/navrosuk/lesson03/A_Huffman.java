package by.it.group310901.navrosuk.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (char value : count.keySet()) {
            // System.out.println(count.get(value) + " " + value);
            LeafNode node = new LeafNode(count.get(value), value);
        ...
        while (priorityQueue.size() != 1) {
            var node1 = priorityQueue.remove();
            var node2 = priorityQueue.remove();
            InternalNode new_node = new InternalNode(node1, node2);
            priorityQueue.add(new_node);
        }
