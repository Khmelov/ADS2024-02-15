...
public class MyRbMap implements SortedMap<Integer, String> {
    ...
    private void headMap(TreeNode node, Integer key, by.it.group351001.radzetskii.lesson12.MyRbMap map) {
        if (node == null) {
            return;
        }
    ...
    private void tailMap(TreeNode node, Integer key, by.it.group351001.radzetskii.lesson12.MyRbMap map) {
        if (node == null) {
            return;
        }
        if (node.key.compareTo(key) >= 0) {
    ...
    public SortedMap<Integer, String> headMap(Integer key) {
        by.it.group351001.radzetskii.lesson12.MyRbMap map = new by.it.group351001.radzetskii.lesson12.MyRbMap();
