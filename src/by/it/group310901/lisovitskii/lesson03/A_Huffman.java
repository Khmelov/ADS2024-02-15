package by.it.group310901.lisovitskii.lesson03;
...
//   - Считывается содержимое файла в строку s.
//   - Создается пустая хэш-карта count, в которой ключами являются символы, а значениями - их частоты в строке.
//   - Для каждого символа в строке его частота обновляется в хэш-карте.
