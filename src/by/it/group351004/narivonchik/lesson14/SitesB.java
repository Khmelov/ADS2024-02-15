...
public class SitesB {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String[] sites = input.split("\\+"); //input: java.mobile+science.org
        ...
        for (String site : disjointSet) {
            if (set.contains(site))       //если сайт мы уже просмотрели - пропускаем
                continue;
            set.add(site);                //иначе добавляем во множество сайт и помещаем размер кластера этого множества
                                          //в hashMap
