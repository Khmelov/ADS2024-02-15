...
public class Lesson03Test {
    ...
    public void A() throws Exception {
        ...
        var f = new File(root + "by/it/group310901/baradzin/lesson03/dataA.txt");
    ...
    public void B() throws Exception {
        var root = System.getProperty("user.dir") + "/src/";
        var f = new File(root + "by/it/group310901/baradzin/lesson03/dataB.txt");
    ...
    public void C() throws Exception {
        var root = System.getProperty("user.dir") + "/src/";
        InputStream stream = new FileInputStream(root + "by/it/group310901/baradzin/lesson03/dataC.txt");
