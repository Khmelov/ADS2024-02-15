package by.it.group351001.budnikov.lesson03;
...
public class Lesson03Test {
    ...
    */
    ...
    public void A() throws Exception {
        ...
        File f = new File(root + "by/it/group351001/budnikov/lesson03/dataHuffman.txt");
    ...
    public void C() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        InputStream stream = new FileInputStream(root + "by/it/group351001/budnikov/lesson03/heapData.txt");
