package by.it.group351001.ivan_shaminko.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (Character chcounter : count.keySet()) {
            Node node = new LeafNode(count.get(chcounter), chcounter);
        ...
        while (priorityQueue.size() > 1) {
            ...
            root = new InternalNode(leftNode, rightNode);
