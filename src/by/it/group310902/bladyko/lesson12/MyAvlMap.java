...
// AVL-дерево — это самосбалансирующееся двоичное дерево поиска,
// в котором для каждого узла выполняется условие,
// что разница между высотами его левого и правого поддеревьев не превышает
// 1. Это свойство обеспечивает эффективный доступ к элементам дерева.
