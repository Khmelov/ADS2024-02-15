...
public class Lesson03Test {
    ...
    */
    ...
    public void B() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        File f = new File(root + "by/it/group351004/lazuta/lesson03/encodeHuffman.txt");
    ...
    public void C() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        InputStream stream = new FileInputStream(root + "by/it/group351004/lazuta/lesson03/heapData.txt");
