package by.it.group310902.mikhovich.lesson15;
...
public class SourceScannerB {
    public static void main(String[] args) {
        ...
        List<by.it.group310902.mikhovich.lesson15.SourceScannerB.FileInfo> filesToProcess = new ArrayList<>();
        ...
        filesToProcess.sort(Comparator.comparingInt(by.it.group310902.mikhovich.lesson15.SourceScannerB.FileInfo::getSize).thenComparing(by.it.group310902.mikhovich.lesson15.SourceScannerB.FileInfo::getPath));

        // Вывод результатов
        for (by.it.group310902.mikhovich.lesson15.SourceScannerB.FileInfo fileInfo : filesToProcess) {
            System.out.println(fileInfo.getSize() + " " + fileInfo.getPath());
        }
    }

    private static Optional<by.it.group310902.mikhovich.lesson15.SourceScannerB.FileInfo> processJavaFile(Path file) { // обработать случаи, когда файл не может быть прочитан или имеет неправильный формат.
        ...
        return Optional.of(new by.it.group310902.mikhovich.lesson15.SourceScannerB.FileInfo(size, relativePath));
    }
