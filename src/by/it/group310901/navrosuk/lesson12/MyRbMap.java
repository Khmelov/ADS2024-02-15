...
public class MyRbMap implements SortedMap<Integer, String> {
    ...
    // Получение брата узла (соседнего потомка родителя)
    ...
    // Получение дедушки узла (родитель родителя)
    ...
    // Получение дяди узла (сосед родителя)
    ...
    // Получение одного из потомков узла
