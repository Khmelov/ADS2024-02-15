package by.it.group351001.pavlyuchenko.lesson12;
...
public class MySplayMap implements NavigableMap<Integer, String> {
    ...
    private void headMap(TreeNode node, Integer key, by.it.group351001.radzetskii.lesson12.MySplayMap map) {
        if (node == null) {
            return;
        }
    ...
    private void tailMap(TreeNode node, Integer key, by.it.group351001.radzetskii.lesson12.MySplayMap map) {
        if (node == null) {
            return;
        }
        if (node.key.compareTo(key) >= 0) {
    ...
    public SortedMap<Integer, String> headMap(Integer key) {
        by.it.group351001.radzetskii.lesson12.MySplayMap map = new by.it.group351001.radzetskii.lesson12.MySplayMap();
