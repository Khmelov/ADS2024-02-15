...
public class Lesson03Test {
    ...
    */
    ...
    public void A() throws Exception {
        ...
        File f = new File(root + "by/it/group351003/egorov_egor/lesson03/dataHuffman.txt");
    ...
    public void B() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        File f = new File(root + "by/it/group351003/egorov_egor/lesson03/encodeHuffman.txt");
    ...
    public void C() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        InputStream stream = new FileInputStream(root + "by/it/group351003/egorov_egor/lesson03/heapData.txt");
