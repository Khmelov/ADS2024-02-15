...
//    Программа перебирает все шаги от 1 до max_size.
//    В зависимости от четности текущего шага, вызывается метод carryingOver, который вычисляет, какие диски перемещаются между стержнями.
//    Высоты стержней обновляются в массиве heights.
//    Если высота максимальна для текущего шага, устанавливается
//    соответствующий индекс в steps_heights; если он уже установлен, выполняется объединение множеств.
