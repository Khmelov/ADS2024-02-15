package by.it.group310901.sikorskiy.lesson06;

import by.it.group310901.usov.lesson06.A_LIS;
import by.it.group310901.usov.lesson06.B_LongDivComSubSeq;
import by.it.group310901.usov.lesson06.C_LongNotUpSubSeq;
...
public class Lesson06Test {
    ...
    public void checkA() throws Exception {
        InputStream inputStream = by.it.group310901.usov.lesson06.A_LIS.class.getResourceAsStream("dataA.txt");
        by.it.group310901.usov.lesson06.A_LIS instance = new A_LIS();
