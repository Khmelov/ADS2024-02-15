...
public class B_MergeSort {
    ...
    //sortArray - метод для сортировки массива. Он использует рекурсию, чтобы разделить массив на подмассивы и затем объединить их.
    //mergeArray - метод для объединения двух отсортированных подмассивов в один отсортированный массив.
