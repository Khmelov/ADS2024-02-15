...
public class ListB<E> implements List<E> {
    ...
    public String toString() {
        ...
        sb.append("[");
        Iterator<E> it = by.it.group351003.pulish.lesson09.ListB.this.iterator();
        if(it.hasNext()){
            sb.append(it.next());
        }
        while(it.hasNext()){
    ...
    public ListIterator<E> listIterator(int index) {
        return new ListIterator<>() {
            ...
            public void remove() {
                if(currentIndex > -1) {
                    by.it.group351003.pulish.lesson09.ListB.this.remove(currentIndex--);
                }
            }
            ...
            public void set(E e) {
                if(currentIndex > -1){
                    by.it.group351003.pulish.lesson09.ListB.this.set(currentIndex,e);
                }
            }

            @Override
            public void add(E e) {
                by.it.group351003.pulish.lesson09.ListB.this.add(e);
            }
        };
    }
    ...
    public ListIterator<E> listIterator() {
        return by.it.group351003.pulish.lesson09.ListB.this.listIterator(0);
    }
