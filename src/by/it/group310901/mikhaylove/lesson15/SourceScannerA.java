package by.it.group310901.mikhaylove.lesson15;
import java.io.File;
...
import java.util.*;
//сканирование всех Java-файлов в извлекая информацию о файлах, которая включает их относительный путь и размер в байтах.
//В процессе работы код исключает файлы, содержащие тесты
