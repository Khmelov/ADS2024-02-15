...
public class Lesson03Test {
    ...
    */
    ...
    public void A() throws Exception {
        ...
        File f = new File(root + "by/it/group310901/usov/lesson03/dataA.txt");
    ...
    public void B() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        File f = new File(root + "by/it/group310901/usov/lesson03/dataB.txt");
    ...
    public void C() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        InputStream stream = new FileInputStream(root + "by/it/group310901/usov/lesson03/dataC.txt");
