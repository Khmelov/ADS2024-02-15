...
// MyPriorityQueue<E> реализует интерфейс Queue<E>, используя кучу на массиве E[] heap.
...
public class MyPriorityQueue<E extends Comparable<E>> implements Queue<E> {
    ...
    // shiftUp и shiftDown обеспечивают правильное расположение элементов в куче.
    //
    ...
    //insert добавляет элемент в кучу и поднимает его вверх,
    ...
    // extractMax удаляет корень кучи,
    // сдвигая вниз последний элемент для восстановления порядка.
    E extractMax(){
        E res=heap[0];
        heap[0]=heap[size-1];
        size--;
