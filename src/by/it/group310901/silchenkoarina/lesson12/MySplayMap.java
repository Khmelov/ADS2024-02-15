...
public class MySplayMap implements NavigableMap<Integer, String> {
    ...
    Node splay(Node node, Integer key) {
        // операции “сжатия”, чтобы переместить узел с заданным ключом
        // к корню дерева, используя повороты влево и вправо
        if (node == null) {
            return null;
        }
    ...
    Node rotateRight(Node node) { //правый поворот вокруг заданного узла
    ...
    public Integer lowerKey(Integer key) {
        // Возвращает наибольший ключ, который меньше заданного.
        if (Root == null)
            return null;
    ...
    public Integer floorKey(Integer key) {
        // Возвращает наибольший ключ, который меньше или равен заданному.
        if (Root == null)
            return null;
    ...
    public Integer ceilingKey(Integer key) {
        //Возвращает наименьший ключ, который больше или равен заданному
        if (Root == null)
            return null;
    ...
    public Integer higherKey(Integer key) {
        //Возвращает наименьший ключ, который больше заданного
        if (Root == null)
            return null;
    ...
    public SortedMap<Integer, String> headMap(Integer toKey) {
        //Возвращает часть карты с ключами, которые меньше заданного
    ...
    void headMap(Node node, Integer toKey, MySplayMap subMap) {
        ...
        //рекурсивное добавление узлов в новую карту
    ...
    public SortedMap<Integer, String> tailMap(Integer fromKey) {
        //Возвращает часть карты с ключами, которые больше или равны заданному
        MySplayMap subMap = new MySplayMap();
    ...
    public Integer firstKey() {
        //Возвращает наименьший ключ в дереве, перемещаясь по левым узлам от корня
        if (Root == null)
            return null;
        Node node = Root;
    ...
    public Integer lastKey() {
        //Возвращает наибольший ключ в дереве, перемещаясь по правым узлам от корня
        if (Root == null)
            return null;
        Node node = Root;
