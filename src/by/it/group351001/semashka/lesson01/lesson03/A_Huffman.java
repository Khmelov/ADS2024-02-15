package by.it.group351001.semashka.lesson01.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (Character ch: count.keySet()){
            LeafNode leaf = new LeafNode(count.get(ch), ch);
        ...
        while (priorityQueue.size() > 1){
            ...
            InternalNode parent = new InternalNode(leaf1, leaf2);
        ...
        priorityQueue.poll().fillCodes(buff);
