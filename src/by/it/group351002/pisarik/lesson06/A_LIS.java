...
public class A_LIS {
    ...
    int getSeqSize(InputStream stream) throws FileNotFoundException {
        ...
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < i; j++) {
                // Если текущий элемент больше предыдущего и длина максимальной возрастающей подпоследовательности, заканчивающейся на предыдущем индексе, плюс 1 больше длины максимальной возрастающей подпоследовательности, заканчивающейся на текущем индексе
